        ...
        <div className="section-container">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="slide-up stagger-1">
              ...
              <p className="text-body leading-relaxed">{t('cookies.whatAreText')}</p>
            </div>

            <div className="slide-up stagger-2">
              <h2 className="heading-md mb-4">{t('cookies.howWeUse')}</h2>
              <p className="text-body leading-relaxed">{t('cookies.howWeUseText')}</p>
            </div>
            ...
            <div className="slide-up stagger-4">
              ...
              <p className="text-body leading-relaxed">{t('cookies.controlText')}</p>
            </div>
